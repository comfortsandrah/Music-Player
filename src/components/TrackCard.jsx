...
const TrackCard = ({ preview, image, title, artistName }) => {
  ...
  return (
    <div
      className="flex flex-col gap-2 rounded-xl justify-center max-w-[180px] max-h-[330px] md:max-w-[220px] md:max-h-[370px] mt-1 text-left hover:shadow hover:cursor-pointer mb-3 p-3"
